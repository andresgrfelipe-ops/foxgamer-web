(() => {
  ...
  const add=card=>{
    ...
    save(); showCartNotice(`${card.dataset.title} añadido al carrito`); document.querySelector('#fox-cart')?.classList.add('is-open'); document.body.classList.add('cart-open'); document.querySelector('#fox-cart-toggle')?.setAttribute('aria-expanded','true');
  };
